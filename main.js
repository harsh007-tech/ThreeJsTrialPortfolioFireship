...
const harshTexture = new THREE.TextureLoader().load('harsh_circle.png');

const harsh = new THREE.Mesh(
  new THREE.BoxGeometry(3,3,3),new THREE.MeshBasicMaterial({map : harshTexture})
)
...
scene.add(pointLight2,lightHelper2);
...
function moveCamera()
{
  ...
  harsh.rotation.y +=0.01;
  harsh.rotation.z += 0.01;
